            ...
            <div class="container h-100">
            	<div class="row h-100 align-items-center">
                	<div class="col-12 text-center">
                        ...
                        <p>
            				<a href="Front-End/Sign_up1.php" class="btn btn-primary my-2">Register as babysitter</a>
            				<a href="Front-End/SignIn_Register.php" class="btn btn-secondary my-2">Find Babysitter</a>
          				</p>
                  <a href="Front-End/Sign_in.php" class="nav-link" href="#">Sign in</a>
                    </div>
